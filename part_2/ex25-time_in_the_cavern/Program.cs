...
Console.WriteLine($"You spent {game.TimePassed.Hours}h {game.TimePassed.Minutes}m {game.TimePassed.Seconds}s on the cave");
...
public class FountainGame
{
    ...
    public TimeSpan TimePassed => DateTime.Now - _startingTime;
